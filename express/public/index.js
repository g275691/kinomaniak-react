...
switch (mode) {
    case "youtube":
        openYoutubeOptions.style.backgroundImage = 'url("../public/img/youtube-logo-options.png")';
        ...
        break;
    case "google":
        openYoutubeOptions.style.backgroundImage = 'url("../public/img/google-logo.png")';
